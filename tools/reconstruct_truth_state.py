...
# -*- coding: utf-8 -*-
"""
Восстановление «истинного» состояния из аудита по правилам:

1. До 13:38:47 МСК (10:38:47 UTC): применяем СТАЛО (col 8)
2. Инцидент 13:38:47: применяем БЫЛО (col 7) — откат wipe
3. После инцидента только:
   - 13:42:13 (10:42:13 UTC) — СТАЛО
   - 13:42:51 (10:42:51 UTC) — СТАЛО
   - 13:47:18 (10:47:18 UTC) — СТАЛО
4. Все остальные записи после инцидента — игнорируем (попытки восстановления)

База: initial-data.js → replay аудита → save forceFull
"""
import json
import re
import sys
